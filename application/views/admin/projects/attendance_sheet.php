...
<!-- <?php echo form_open_multipart(admin_url('projects/attendance_upload_file/' . $project->id), ['class' => 'dropzone', 'id' => 'project-files-upload']); ?>
<input type="file" name="file" multiple />
<?php echo form_close(); ?> -->

<form action ="<?php echo admin_url('projects/attendance_upload_file/' . $project->id);?>" class = "dropzone" id="attendance-files-upload"> 
