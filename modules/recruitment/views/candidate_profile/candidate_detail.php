			...
			<div class="panel-body">
				...
				<div class="col-md-12">
					<div class="horizontal-scrollable-tabs preview-tabs-top">
						...
						<div class="horizontal-tabs">
							<ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
								...
								<li role="presentation">
									<a href="#salary_details" aria-controls="salary_details" role="tab" data-toggle="tab" aria-controls="salary_details">
										<i class="fa fa-dollar"></i>&nbsp;<?php echo _l('salary_details'); ?>
									</a>
								</li>
							</ul>
						</div>
					...
					<div class="tab-content">
						...
						<!-- Start : CTC Details  -->
						<div role="tabpanel" class="tab-pane active" id="salary_details">
											...
											if(is_array($payroll_addition))
											{
												...
												{ ?>
													...
													<th>
														...
														value="<?php echo $value['unit_amount']; ?>" pattern="[0-9]*" readonly />
													</th>
												</tr>
											<?php $i++; } } ?>
										</tbody>
