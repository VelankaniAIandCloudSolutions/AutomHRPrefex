        ...
        <div class="panel_s">
          <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <select name="skill[]" id="skill" data-live-search="true" class="selectpicker" multiple="true" data-actions-box="true" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                        <?php if (isset($candidate->skill)) {
                          $skill_id = explode(',', $candidate->skill);
                        }; ?>

                        <?php foreach ($skills as $dpkey =>  $skill) { ?>
                          <option value="<?php echo html_entity_decode($skill['id']); ?>" <?php if (isset($skill_id) && in_array($skill['id'], $skill_id) == true) {
                                                                                            echo 'selected';
                                                                                          } ?>> <?php echo html_entity_decode($skill['skill_name']); ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-12">
                <div class="panel panel-success">
                  <div class="panel-heading"><?php echo _l('salary_details') ?></div>
                  <div class="panel-body">

                    <!--  Start : Salary Addition -->
                    <p class="bold margin-top-15 general-infor-color"><?php echo _l('addition') . '(' . _l('yearly') . ')'; ?></p>
                    ...
                    <div class="col-md-12 padding-left-right-0">
                      <table class="table table-hover table-radius">
                        ...
                        <tbody>
                          <?php
                          $all_addtional = $this->db->get_where(db_prefix() . 'candidate_salary_breakup', array('candidate_id' => $candidate->id))->row_array();
                          ...
                          if (is_array($payroll_addition)) {
                            ...
                            foreach ($payroll_addition as $key => $value) { ?>
                              <tr>
                                ...
                                <th>
                                  <input type="number" class="form-control" name="<?php echo $value['addtion_name']; ?>" value="<?php echo $value['unit_amount']; ?>" min="0" pattern="[0-9]*" />
                                </th>
                              </tr>
                          <?php $i++;
                            }
                    ...
                    <!--  Start : Salary Deduciton -->
                    <p class="bold margin-top-15 general-infor-color"><?php echo _l('deduction') . '(' . _l('yearly') . ')'; ?></p>
                    <hr class="margin-top-10 general-infor-hr" />
                    <div class="col-md-12 padding-left-right-0">
                      <table class="table table-hover table-radius">
                        <thead>
                          ...
                          if (is_array($payroll_deduction)) {
                            ...
                            foreach ($payroll_deduction as $key => $value) { ?>
                              <tr>
                                ...
                                <th>
                                  <input type="number" class="form-control" name="<?php echo $value['model_name']; ?>" value="<?php echo $value['unit_amount']; ?>" min="0" pattern="[0-9]*" />
                                </th>
                              </tr>
                          <?php $i++;
                            }
